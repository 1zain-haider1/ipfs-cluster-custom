...
# git@github.com:1zain-haider1/ipfs-cluster-custom.git
ENV GOPATH      /go
ENV SRC_PATH    $GOPATH/src/github.com/1zain-haider1/ipfs-cluster-custom
ENV GO111MODULE on
...
RUN git config --global --add safe.directory /go/src/github.com/1zain-haider1/ipfs-cluster-custom
RUN make install
...
ENV GOPATH                 /go
ENV SRC_PATH               /go/src/github.com/1zain-haider1/ipfs-cluster-custom
